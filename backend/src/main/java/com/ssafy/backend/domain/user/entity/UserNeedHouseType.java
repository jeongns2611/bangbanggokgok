...
@Getter
@Entity
@Table(name = "user_need_house_type")
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class UserNeedHouseType extends BaseEntity {

    @EmbeddedId
    private UserNeedHouseTypeId id;
    ...
    @Builder
    public UserNeedHouseType(UserNeedHouseTypeId id, UserNeed userNeed, CommonCodeDetail commonCodeDetail) {
        this.id = id;
