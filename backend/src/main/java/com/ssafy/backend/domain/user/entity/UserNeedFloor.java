...
@Getter
@Entity
@Table(name = "user_need_floor")
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class UserNeedFloor extends BaseEntity {

    @EmbeddedId
    private UserNeedFloorId id;
    ...
    @Builder
    public UserNeedFloor(UserNeedFloorId id, UserNeed userNeed, CommonCodeDetail commonCodeDetail) {
        this.id = id;
